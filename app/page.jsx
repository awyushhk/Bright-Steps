...
import { Brain, Users, ClipboardList, Shield, ChevronRight, Menu, X, Star, Clock, Target, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 border-b bg-white/90 backdrop-blur-md shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Button className="text-sm bg-indigo-600 hover:bg-indigo-700 rounded-xl px-5" onClick={() => router.push("/sign-up")}>
              Get Started
            </Button>
          </div>
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        ...
        {/* Background image via Unsplash (child playing) */}
        <div
        ...
        <div className="relative container mx-auto px-4 py-24">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button
                size="lg"
                className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl px-8 h-13 text-base shadow-lg shadow-indigo-900/40"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10 rounded-xl px-8 h-13 text-base backdrop-blur-sm bg-white/5"
            ...
            {[
              {
                ...
                desc: "Create a profile with your child's age and basic information.",
                icon: Users,
              },
              {
                step: "2",
                title: "Complete Screening",
                desc: "Answer age-appropriate questions and optionally upload a short video.",
                icon: ClipboardList,
              },
              {
                step: "3",
                title: "View Results",
                desc: "Receive a comprehensive AI-assisted assessment with clear risk indicators.",
                icon: Target,
              },
            ...
            {[
              {
                ...
                desc: "Answer guided questions and record short home videos designed around everyday interactions.",
                color: "bg-indigo-50 text-indigo-600",
              },
              {
                icon: ClipboardList,
                title: "Structured Review",
                desc: "Observations are organized into clear summaries that help support thoughtful decision-making.",
                color: "bg-violet-50 text-violet-600",
              },
              {
                icon: Brain,
                title: "Behavioral Insights",
                desc: "Subtle developmental patterns are highlighted using Gemini AI to assist understanding over time.",
                color: "bg-fuchsia-50 text-fuchsia-600",
              },
              {
                icon: Shield,
                title: "Clinically Responsible",
                desc: "Designed to assist professional judgment within a transparent and accountable workflow.",
            ...
            {[
              {
                ...
                a: "No. Bright Steps is a screening support tool designed to help families and clinicians identify potential developmental concerns early. It does not replace a formal clinical evaluation or diagnosis.",
              },
              {
                q: "Who can use Bright Steps?",
                a: "Parents and guardians of children aged 6 months to 5 years can complete screenings. Clinicians also have access to a dedicated dashboard to review and manage submitted cases.",
              },
              {
                q: "How long does a screening take?",
                a: "Most screenings take around 10–15 minutes to complete, including answering the questionnaire and optionally uploading a short video.",
              },
              {
                q: "Is my child's data secure?",
                a: "Yes. All data is encrypted and stored securely. Videos are stored on Cloudinary with controlled access, and your personal information is never shared without consent.",
              },
              {
                q: "What happens after I submit a screening?",
                a: "A risk assessment is generated immediately using AI. If your account is connected to a clinical team, a clinician will review the case and follow up with recommendations.",
              },
            ].map(({ q, a }, i) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {[
                  { label: "Sign In",    action: () => router.push("/sign-in")  },
                  { label: "Sign Up",    action: () => router.push("/sign-up")  },
                  { label: "Dashboard",  action: () => router.push("/dashboard") },
                ].map(({ label, action }) => (
                  <li key={label}>
                    <button onClick={action} className="hover:text-indigo-400 transition-colors text-left">
                      {label}
                    </button>
                  </li>
                ))}
